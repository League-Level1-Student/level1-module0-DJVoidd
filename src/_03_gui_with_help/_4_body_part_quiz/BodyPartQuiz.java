...
if (guess.equals("arnold schwarzenegger")){
	...
	JOptionPane.showMessageDialog(null, "You got it wrong :(\nThe answer was arnold schwarzenegger");	
		...
		if (guess2.equals("leonardo dicaprio")){
			...
			JOptionPane.showMessageDialog(null, "You got it wrong :(\nThe answer was leonardo dicaprio");	
		}
		showNextImage();
		...
		if (guess4.equals("jack black")){
			...
			JOptionPane.showMessageDialog(null, "You got it wrong :(\nThe answer was jack black");	
		}
		// 9. Show them their current score
JOptionPane.showMessageDialog(null, "Youre final score is: " + score + "!");
	}
